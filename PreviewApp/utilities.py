...
def updatepaymentadvice(foo, rate, currency_type, purpose, doclanguage,user,request):
    url = "http://10.0.33.38:280/api/Values"
...
def updateremittanceallocation(foo, doclanguage,user,request):
    url = "http://10.0.33.38:280/api/PairedReceipt"
...
def updatenonpairedreceipt(foo, doclanguage,user,request):
    url = "http://10.0.33.38:280/api/Nonpaired"
